...
import { Typo18SteelHKGroteskSemiBold } from '../../../common/styleGuide/Typos'
            ...
            <RouteComponents>
               <Anchor onClick={(event) => this.handleClick(event)}>
                  <Typo18SteelHKGroteskSemiBold>
                     {t('strings:userheader.home')}
                  </Typo18SteelHKGroteskSemiBold>
               </Anchor>
               <Anchor>
                  <Typo18SteelHKGroteskSemiBold>
                     {t('strings:userheader.requests')}
                  </Typo18SteelHKGroteskSemiBold>
               </Anchor>
               <Anchor onClick={(event) => this.handleClick(event)}>
                  <Typo18SteelHKGroteskSemiBold>
                     {t('strings:userheader.report an issue')}
                  </Typo18SteelHKGroteskSemiBold>
               </Anchor>
               <Anchor onClick={(event) => this.handleClick(event)}>
                  <Typo18SteelHKGroteskSemiBold>
                     {t('strings:userheader.previous slots')}
                  </Typo18SteelHKGroteskSemiBold>
               </Anchor>
               <Anchor>
                  <Typo18SteelHKGroteskSemiBold>
                     {t('strings:userheader.profile')}
                     {}
                  </Typo18SteelHKGroteskSemiBold>
               </Anchor>
            </RouteComponents>
